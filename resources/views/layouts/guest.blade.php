...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-28 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            @if(Session::has('warning'))
                <div class="fixed top-5 bg-yellow-100 border-t-4 border-yellow-500  rounded-b text-yellow-900 px-4 py-3 shadow-md" role="alert">
                    <div class="flex">
